...
CONFIG.CFG_DATA_WIDTH {32} \
  ...
  regenerate_bd_layout -hierarchy [get_bd_cells /signal_generator] -layout_string {
   guistr: "# # String gsaved with Nlview 6.5.12  2016-01-29 bk=1.3547 VDI=39 GEI=35 GUI=JA:1.6
#  -string -flagsOSRD
preplace port dac_clk -pg 1 -y 60 -defaultsOSRD
preplace port S_AXI -pg 1 -y 40 -defaultsOSRD
preplace port dac_sel -pg 1 -y 100 -defaultsOSRD
preplace port dac_wrt -pg 1 -y 120 -defaultsOSRD
preplace port dac_rst -pg 1 -y 80 -defaultsOSRD
preplace port aclk -pg 1 -y 80 -defaultsOSRD
preplace portBus enable -pg 1 -y 10 -defaultsOSRD
preplace portBus dac_dat -pg 1 -y 140 -defaultsOSRD
preplace portBus aresetn -pg 1 -y 100 -defaultsOSRD
preplace inst dds_compiler_0 -pg 1 -lvl 3 -y 70 -defaultsOSRD
preplace inst sig_gen_config -pg 1 -lvl 1 -y 80 -defaultsOSRD
preplace inst axis_constant_0 -pg 1 -lvl 2 -y 60 -defaultsOSRD
preplace inst clk_wiz_1 -pg 1 -lvl 3 -y 200 -defaultsOSRD
preplace inst axis_red_pitaya_dac_0 -pg 1 -lvl 4 -y 100 -defaultsOSRD
...
preplace netloc clk_wiz_1_locked 1 3 1 790
preplace netloc clk_wiz_1_clk_out1 1 3 1 780
preplace netloc aresetn_1 1 0 1 N
preplace netloc dds_compiler_0_M_AXIS_DATA 1 3 1 N
preplace netloc sig_gen_config_cfg_data 1 1 1 250
preplace netloc axis_red_pitaya_dac_0_dac_clk 1 4 1 NJ
preplace netloc aresetn1_1 1 0 3 NJ 10 NJ 120 NJ
preplace netloc axis_red_pitaya_dac_0_dac_dat 1 4 1 NJ
preplace netloc clk_sync_clk_out1 1 0 4 10 0 250 0 490 0 780
levelinfo -pg 1 -20 130 370 640 900 1030 -top -10 -bot 260
",
}
...
proc create_hier_cell_gpio_interface { parentCell nameHier } {
  ...
  # Create instance: enable_receive, and set properties
  set enable_receive [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 enable_receive ]
  set_property -dict [ list \
CONFIG.DIN_FROM {16} \
CONFIG.DIN_TO {16} \
CONFIG.DOUT_WIDTH {1} \
  ...
  # Create instance: exp_interface_1, and set properties
  set block_name exp_interface
  set block_cell_name exp_interface_1
  if { [catch {set exp_interface_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $exp_interface_1 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
...
CONFIG.DOUT_WIDTH {8} \
  ...
  # Create port connections
  connect_bd_net -net Net [get_bd_pins exp_data_n] [get_bd_pins exp_interface_0/exp_data]
  connect_bd_net -net Net1 [get_bd_pins exp_data_p] [get_bd_pins exp_interface_1/exp_data]
  connect_bd_net -net axi_cfg_register_0_cfg_data [get_bd_pins enable_receive/Din] [get_bd_pins gpio_register/cfg_data] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din]
  ...
  connect_bd_net -net xlslice_1_Dout [get_bd_pins exp_interface_1/data] [get_bd_pins xlslice_1/Dout]
  connect_bd_net -net xlslice_2_Dout [get_bd_pins enable] [get_bd_pins enable_receive/Dout]
...
preplace port S_AXI -pg 1 -y 40 -defaultsOSRD
preplace port aclk -pg 1 -y 60 -defaultsOSRD
preplace portBus enable -pg 1 -y 250 -defaultsOSRD
preplace portBus exp_data_n -pg 1 -y 60 -defaultsOSRD
preplace portBus exp_data_p -pg 1 -y 130 -defaultsOSRD
preplace portBus aresetn -pg 1 -y 80 -defaultsOSRD
preplace inst gpio_register -pg 1 -lvl 1 -y 60 -defaultsOSRD
preplace inst xlslice_0 -pg 1 -lvl 2 -y 40 -defaultsOSRD
preplace inst xlslice_1 -pg 1 -lvl 2 -y 130 -defaultsOSRD
preplace inst enable_receive -pg 1 -lvl 2 -y 250 -defaultsOSRD
preplace inst exp_interface_0 -pg 1 -lvl 3 -y 40 -defaultsOSRD
preplace inst exp_interface_1 -pg 1 -lvl 3 -y 130 -defaultsOSRD
...
preplace netloc xlconstant_0_dout 1 0 1 NJ
preplace netloc xlslice_2_Dout 1 2 2 NJ 250 NJ
preplace netloc Net1 1 3 1 N
preplace netloc Net 1 3 1 NJ
preplace netloc clk_sync_clk_out1 1 0 1 NJ
preplace netloc xlslice_0_Dout 1 2 1 NJ
levelinfo -pg 1 -10 120 370 640 790 -top -10 -bot 300
",
}
...
preplace port dac_rst_o -pg 1 -y 370 -defaultsOSRD
preplace port dac_clk_o -pg 1 -y 350 -defaultsOSRD
preplace port adc_enc_n_o -pg 1 -y 20 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 100 -defaultsOSRD
preplace port dac_sel_o -pg 1 -y 390 -defaultsOSRD
preplace port dac_wrt_o -pg 1 -y 410 -defaultsOSRD
preplace port Vaux8 -pg 1 -y 60 -defaultsOSRD
preplace port adc_clk_n_i -pg 1 -y 290 -defaultsOSRD
...
preplace portBus exp_p_tri_io -pg 1 -y 220 -defaultsOSRD
preplace portBus exp_n_tri_io -pg 1 -y 200 -defaultsOSRD
preplace portBus daisy_p_o -pg 1 -y 520 -defaultsOSRD
preplace portBus led_o -pg 1 -y 120 -defaultsOSRD
...
preplace portBus dac_dat_o -pg 1 -y 430 -defaultsOSRD
...
preplace inst clocking_system -pg 1 -lvl 1 -y 280 -defaultsOSRD
preplace inst gpio_interface -pg 1 -lvl 4 -y 220 -defaultsOSRD
preplace inst signal_generator -pg 1 -lvl 4 -y 390 -defaultsOSRD
preplace inst receive_chain -pg 1 -lvl 2 -y 160 -defaultsOSRD
preplace netloc S_AXI_1 1 1 3 260 280 NJ 280 790
preplace netloc S_AXI_2 1 3 1 N
preplace netloc axis_red_pitaya_dac_0_dac_rst 1 4 1 NJ
preplace netloc axis_red_pitaya_dac_0_dac_sel 1 4 1 NJ
...
preplace netloc adc_dat_a_i_1 1 0 2 NJ 190 NJ
preplace netloc processing_system_M03_AXI 1 3 1 820
preplace netloc util_ds_buf_2_OBUF_DS_N 1 4 1 NJ
preplace netloc ps_0_axi_periph_M00_AXI 1 1 3 250 20 NJ 20 790
preplace netloc xlconstant_0_dout 1 1 3 280 310 NJ 310 800
...
preplace netloc ps_axi_periph_M01_AXI 1 1 3 240 10 NJ 10 800
...
preplace netloc enable_1 1 1 4 270 300 NJ 300 840 290 1120
preplace netloc axis_red_pitaya_dac_0_dac_dat 1 4 1 NJ
preplace netloc adc_clk_p_i_1 1 0 1 NJ
preplace netloc clk_sync_clk_out1 1 2 2 530 290 830
preplace netloc daisy_n_i_1 1 0 4 NJ 540 NJ 540 NJ 540 NJ
levelinfo -pg 1 0 130 400 660 980 1140 -top 0 -bot 590
",
}
