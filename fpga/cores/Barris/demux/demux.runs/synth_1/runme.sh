...
HD_PWD='/home/tighe/Desktop/redmasters/FPGA_Xilinx/Cores/Barris/demux/demux.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log demux.vds -m64 -mode batch -messageDb vivado.pb -notrace -source demux.tcl
