...
HD_PWD='/home/tighe/Desktop/redmasters/FPGA_Xilinx/Cores/Barris/demux/demux.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log demux.vdi -applog -m64 -messageDb vivado.pb -mode batch -source demux.tcl -notrace
