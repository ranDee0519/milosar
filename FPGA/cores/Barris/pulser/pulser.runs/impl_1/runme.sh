...
HD_PWD='/home/tighe/Desktop/redmasters/FPGA_Xilinx/Cores/Barris/pulser/pulser.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pulser.vdi -applog -m64 -messageDb vivado.pb -mode batch -source pulser.tcl -notrace
