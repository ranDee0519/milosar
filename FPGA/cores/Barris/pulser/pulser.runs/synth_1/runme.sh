...
HD_PWD='/home/tighe/Desktop/redmasters/FPGA_Xilinx/Cores/Barris/pulser/pulser.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pulser.vds -m64 -mode batch -messageDb vivado.pb -notrace -source pulser.tcl
