...
HD_PWD='/home/tighe/Desktop/redmasters/FPGA_Xilinx/Cores/Barris/chirp_counter/chirp_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log chirp_counter.vds -m64 -mode batch -messageDb vivado.pb -notrace -source chirp_counter.tcl
