...
HD_PWD='/home/tighe/Desktop/redmasters/FPGA_Xilinx/Cores/Barris/dropper/dropper.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dropper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source dropper.tcl
