...
HD_PWD='/home/tighe/Desktop/redmasters/FPGA_Xilinx/Cores/Barris/pri_trigger/pri_trigger.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pri_trigger.vds -m64 -mode batch -messageDb vivado.pb -notrace -source pri_trigger.tcl
