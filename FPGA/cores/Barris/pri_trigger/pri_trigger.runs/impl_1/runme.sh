...
HD_PWD='/home/tighe/Desktop/redmasters/FPGA_Xilinx/Cores/Barris/pri_trigger/pri_trigger.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pri_trigger.vdi -applog -m64 -messageDb vivado.pb -mode batch -source pri_trigger.tcl -notrace
